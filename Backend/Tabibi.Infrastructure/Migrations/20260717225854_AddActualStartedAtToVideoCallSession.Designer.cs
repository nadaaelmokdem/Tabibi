...
namespace Tabibi.Infrastructure.Migrations
{
    ...
    [Migration("20260717225854_AddActualStartedAtToVideoCallSession")]
    partial class AddActualStartedAtToVideoCallSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tabibi.Core.Models.AiRecharge", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("MessagesGranted")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tabibi.Core.Models.DoctorAvailability", b =>
                {
                    ...
                    b.HasIndex("DoctorId", "SpecificDate", "StartTime", "EndTime")
                        .IsUnique()
            ...
            modelBuilder.Entity("Tabibi.Core.Models.Payment", b =>
                {
                    ...
                    b.HasOne("Tabibi.Core.Models.ChatSession", "ChatSession")
                        .WithOne("Payment")
                        .HasForeignKey("Tabibi.Core.Models.Payment", "SessionId");
